...
cursor = conexion.cursor()
consulta = ("SELECT audio_name FROM audios WHERE owner = 'izzi' AND tipo = 'soporte' and status in ('Transcrito','Reprocesar') and guia = 'guia_set_10' ORDER BY id DESC LIMIT 1")
